...
void addObjectMethods(py::module& m, Environment& env) {
  ...
  py::enum_<OrtSparseFormat>(m, "OrtSparseFormat")
      .value("ORT_SPARSE_UNDIFNED", OrtSparseFormat::OrtSparseUndefined)
      .value("ORT_SPARSE_COO", OrtSparseFormat::OrtSparseCoo)
      .value("ORT_SPARSE_CSR", OrtSparseFormat::OrtSparseCsr)
      .value("ORT_SPARSE_BLOCK_SPARSE", OrtSparseFormat::OrtSparseBlockSparse);

  // py::class_<SparseTensor> sparse_tensor_binding(m, "SparseTensor");
  //sparse_tensor_bid
  ...
  /// XXX: Sparsity. Make sure we support SparseTensors
